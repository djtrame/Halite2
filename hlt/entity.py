...
class Ship(Entity):
    ...
    def can_dock(self, planet):
        ...
        :rtype: bool
        """
        #dtrame 12/28/17 adding logging to debug my first X turns code with the first 3 ships
        #calc_dist_between = self.calculate_distance_between(planet)
        #logging.info("Calc distance between: " + str(calc_dist_between))
        #logging.info("Calc radius + dock radius + ship radius: " + str(planet.radius + constants.DOCK_RADIUS + constants.SHIP_RADIUS))
